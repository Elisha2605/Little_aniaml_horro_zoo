...
public class Animal {
  ...
  private int x1 = r.nextInt(9)+1;
  private int y1 = r.nextInt(9)+1;
  private int x2 = r.nextInt(9)+1;
  private int y2 = r.nextInt(9)+1;  
  ...
  public void moveX(int x) {
   int moveX = r.nextInt(9)+1;
  }
  
  public void moveY(int y) {
   int moveY = r.nextInt(9)+1;
  }
